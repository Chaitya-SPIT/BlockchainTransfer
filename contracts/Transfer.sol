...
contract Transfer {
    ...
    officeInfo  o1 = officeInfo({p1: 1, p2: 0, p3: 4, name: "Mulund"});
    officeInfo  o2 = officeInfo({p1: 0, p2: 0, p3: 2, name: "Chembeur"});
    officeInfo  o3 = officeInfo({p1: 0, p2: 1, p3: 4, name: "Ghatkopar"});
    officeInfo  o4 = officeInfo({p1: 1, p2: 3, p3: 1, name: "Kurla"});
    officeInfo  o5 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Parel"});
     officeInfo  o6 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Dadar"});
     officeInfo  o7 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Byculla"});
     officeInfo  o8 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Malabar"});
     officeInfo  o9 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Bandra"});
     officeInfo  o10 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Mahim"});
     officeInfo  o11 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Ville Parle"});
     officeInfo  o12 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Andheri"});
     officeInfo  o13 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Goregoan"});
     officeInfo  o14 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Kandivli"});
     officeInfo  o15 = officeInfo({p1: 0, p2: 4, p3: 0, name: "Borivali"});
